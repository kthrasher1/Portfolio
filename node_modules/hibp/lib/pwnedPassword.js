...
var _pwnedPasswordRange = _interopRequireDefault(require("./pwnedPasswordRange"));
...
var pwnedPassword = function pwnedPassword(password) {
  var hash = (0, _jsSha.default)(password).toUpperCase();
  var prefix = hash.slice(0, 5);
  var suffix = hash.slice(5);
  return (0, _pwnedPasswordRange.default)(prefix) // filter to matching suffix
  .then(function (arr) {
